<?php
// admin/usuarios/crear.php - Crear nuevo usuario
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                if (empty($error)) {
                    ...
                    $nombre_completo = $usuario = $email = $password = '';
                    $rol_id = 3;
                    $activo = 1;
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-volver { background: #445960; color: white; padding: 10px 20px; text-decoration: none; border-radius: 8px; display: inline-block; margin-bottom: 20px; transition: all 0.3s ease; }
            ...
            <form method="POST" action="">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="telefono" placeholder="Ej: 3001234567" value="<?php echo htmlspecialchars($telefono ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label>Sede</label>
                        <select name="sede">
                            ...
                            <?php foreach ($sedes as $sede_opcion): ?>
                                <option value="<?php echo htmlspecialchars($sede_opcion); ?>" <?php echo ($sede ?? '') == $sede_opcion ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="perfil_usuario" id="perfil_usuario" onchange="actualizarCargos()">
                            ...
                            <?php foreach ($perfiles as $perfil): ?>
                                <option value="<?php echo htmlspecialchars($perfil); ?>" <?php echo ($perfil_usuario ?? '') == $perfil ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="rol_id">
                            <?php foreach ($roles as $rol): ?>
                                <option value="<?php echo $rol['id']; ?>" <?php echo ($rol_id ?? 3) == $rol['id'] ? 'selected' : ''; ?>>
