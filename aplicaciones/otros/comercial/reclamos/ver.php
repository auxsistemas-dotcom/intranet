<?php
// aplicaciones/otros/comercial/reclamos/ver.php - Ver chat del reclamo
...
// ============================================
$stmt = $pdo->prepare("
    SELECT r.*, u.nombre_completo as asesor_nombre, u.usuario as asesor_usuario
    FROM reclamos r
...
// ============================================
// VERIFICAR QUE SEA EL DUEÑO DEL RECLAMO
// ============================================
if ($reclamo['asesor_id'] != $usuario_id) {
    $_SESSION['error'] = "❌ No tienes permiso para ver este reclamo";
    header('Location: index.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validaciones del mensaje (solo si no hubo error con la imagen)
    if (empty($error)) {
        if (empty($mensaje) && empty($imagen_nombre)) {
            ...
            try {
                ...
                // Actualizar el estado a "en_revision" si estaba pendiente
...
<head>
    ...
    <title>Reclamo #<?php echo str_pad($reclamo['id'], 4, '0', STR_PAD_LEFT); ?> | INTRANET</title>
            ...
            <div class="reclamo-meta">
                ...
                <div class="meta-item">
                    ...
                    <div class="info">
                        ...
                        <span class="valor"><?php echo htmlspecialchars($reclamo['asesor_nombre']); ?></span>
                    </div>
                </div>
                <div class="meta-item">
